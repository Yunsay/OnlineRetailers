<template>
  <div class="getaways">
    <div class="getaways-list">
      <ul>
        <li class="item" v-for="(item, index) in getawayss">
          <div class="card">
            <div class="card-img">
...
<script>
  import {Getaways} from 'api/getaways'
  ...
  export default {
    ...
    methods: {
      _Getaways() {
        Getaways().then((res) => {
          this.getawayss = res.cards
        })
      },
      price1(index) {
        let item = this.getawayss[index];
